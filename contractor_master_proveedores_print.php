...
require_once("include/contractor_master_proveedores_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "contractor_master_proveedores" );
