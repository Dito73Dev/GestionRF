...
$globalSettings["strSMTPUser"] = "gestionsis@mincit.gov.co";
$globalSettings["strSMTPServer"] = "smtp.office365.com";
$globalSettings["strSMTPPort"] = "587";
$globalSettings["strSMTPPassword"] = "Mincomercio2022*";
$globalSettings["strFromEmail"] = "gestionsis@mincit.gov.co";
...
$globalSettings["ProjectLogo"]["Spanish"] = "Recursos Físicos";
...
$globalSettings["jwtSecret"] = "01cnwXcl4ordaQ8BRfy2";
...
$projectBuildKey = "731_1695059568";
$wizardBuildKey = "41163";
$projectBuildNumber = "731";
...
$tableCaptions["Spanish"]["alasientos"] = "Alasientos";
$tableCaptions["Spanish"]["alconceptos"] = "Conceptos";
$tableCaptions["Spanish"]["tparam_estadoasientos"] = "Tparam Estadoasientos";
$tableCaptions["Spanish"]["inv_almacen"] = "Inv Almacen";
$tableCaptions["Spanish"]["tparam_tipo_movimiento"] = "Tparam Tipo Movimiento";
$tableCaptions["Spanish"]["tparam_status"] = "Tparam Status";
$tableCaptions["Spanish"]["aldevindiv_sol"] = "Traslados y Reintegros";
$tableCaptions["Spanish"]["aldevindiv_sol_vinc"] = "Elementos";
$tableCaptions["Spanish"]["aldevindiv_sol_estados"] = "Aldevindiv Sol Estados";
$tableCaptions["Spanish"]["aldevindiv_sol_type"] = "Aldevindiv Sol Type";
$tableCaptions["Spanish"]["aldevindiv_traslados"] = "Aldevindiv Traslados";
$tableCaptions["Spanish"]["aldevindiv_reintegros"] = "Aldevindiv Reintegros";
$tableCaptions["Spanish"]["q_global_enservicio"] = "Q Global Enservicio";
$tableCaptions["Spanish"]["aldevindiv_sol_vinc_adm"] = ":: Elementos";
$tableCaptions["Spanish"]["aldevindiv_sol_estados_vinc"] = "Aldevindiv Sol Estados Vinc";
$tableCaptions["Spanish"]["alcuentasalma"] = "Cuentas";
$tableCaptions["Spanish"]["alelemdevolutivo"] = "Devolutivos";
$tableCaptions["Spanish"]["almarcas"] = "Almarcas";
$tableCaptions["Spanish"]["cgc_0"] = "Cgc 0";
$tableCaptions["Spanish"]["cgc_1"] = "Cgc 1";
$tableCaptions["Spanish"]["cgc_2"] = "Cgc 2";
$tableCaptions["Spanish"]["cgc_4"] = "Cgc 4";
$tableCaptions["Spanish"]["cgc_6"] = "Cgc 6";
$tableCaptions["Spanish"]["Mi_inventario"] = "Mi Inventario";
$tableCaptions["Spanish"]["alelemconsumo"] = "Consumo";
$tableCaptions["Spanish"]["tparam_sn"] = "Tparam Sn";
$tableCaptions["Spanish"]["geunidmedida"] = "Geunidmedida";
$tableCaptions["Spanish"]["q_ctrl_alelemdevolutivo"] = "Q Ctrl Alelemdevolutivo";
$tableCaptions["Spanish"]["q_ctrl_alelemconsumo"] = "Q Ctrl Alelemconsumo";
$tableCaptions["Spanish"]["tparam_valor_uvt"] = "Tparam Valor Uvt";
$tableCaptions["Spanish"]["global_periodos"] = "Global Periodos";
$tableCaptions["Spanish"]["geclasedocto"] = "Geclasedocto";
$tableCaptions["Spanish"]["aldevindiv_sol_sign_a"] = "Aldevindiv Sol Sign A";
$tableCaptions["Spanish"]["aldevindiv_sol_vinc_sign"] = "Elementos";
$tableCaptions["Spanish"]["aldevindiv_sol_sign_b"] = "Aldevindiv Sol Sign B";
$tableCaptions["Spanish"]["gedocumentos_ingresos"] = "Devolutivos";
$tableCaptions["Spanish"]["alasientos_gestion"] = "Gestión | Ingresos";
$tableCaptions["Spanish"]["global_type_doc"] = "Global Type Doc";
$tableCaptions["Spanish"]["contractor_master_proveedores"] = "Contractor Master Proveedores";
$tableCaptions["Spanish"]["q_ctrl_numdocumento"] = "Q Ctrl Numdocumento";
$tableCaptions["Spanish"]["dependencias_001"] = "Dependencias 001";
$tableCaptions["Spanish"]["dependencia"] = "Dependencia";
$tableCaptions["Spanish"]["almovdevdia_ingresos_d"] = "Ingresos";
$tableCaptions["Spanish"]["global_type_tax"] = "Global Type Tax";
$tableCaptions["Spanish"]["alelemdevolutivo_consulta"] = "Localización de recursos del inventario";
$tableCaptions["Spanish"]["almovinddia_ingresos_d"] = "Elementos";
$tableCaptions["Spanish"]["cgc_consulta"] = "Catálogo General de Cuentas";
$tableCaptions["Spanish"]["gedocumentos_ingresos_consumo"] = "Consumo";
$tableCaptions["Spanish"]["almovconsdia_ingresos"] = "Almovconsdia Ingresos";
$tableCaptions["Spanish"]["alelemconsumo_consulta"] = "Alelemconsumo Consulta";
$tableCaptions["Spanish"]["gedocumentos"] = "Gedocumentos";
$tableCaptions["Spanish"]["alasientos_gestion_e"] = "Gestión | Egresos";
$tableCaptions["Spanish"]["global_type_legal"] = "Global Type Legal";
$tableCaptions["Spanish"]["gedocumentos_egresos"] = "Gedocumentos Egresos";
$tableCaptions["Spanish"]["gedocumentos_egresos_consumo"] = "Gedocumentos Egresos Consumo";
$tableCaptions["Spanish"]["aldevindiv_egresos"] = "Aldevindiv Egresos";
$tableCaptions["Spanish"]["almovinddia"] = "Almovinddia";
...
function generarToken() {
    ...
    $numeros = str_pad(rand(0, 9999999), 7, '0', STR_PAD_LEFT); // Genera un número de 7 dígitos
    $token = $letra . $numeros; // Concatena la letra y los números
...
function generarTokenSign() {
    ...
    for ($i = 0; $i < $grupos; $i++) {
        ...
        // Generar la letra mayúscula del grupo
        $grupo .= $letrasMayusculas[rand(0, strlen($letrasMayusculas) - 1)];

        // Generar los números del grupo
        for ($j = 0; $j < 7; $j++) {
            $grupo .= $numerosS[rand(0, strlen($numerosS) - 1)];
        }

        // Agregar el grupo al token
        $tokenS .= $grupo;

        // Agregar un guion después de cada grupo, excepto el último
        if ($i < $grupos - 1) {
            $tokenS .= '-';
        }
    }
...
// Genera variables de sesion

$_SESSION['build'] = $projectBuildNumber;
$ip = $_SERVER['REMOTE_ADDR'];
$_SESSION['user_ip'] = $ip;
$_SESSION['GEntidad'] = "Ministerio de Comercio, Industria y Turismo";
$_SESSION['GURL'] = "http://localhost:8086/";
$_SESSION['EmailBCC'] = "mincit.osi@gmail.com";
$_SESSION['logo'] = "https://presupuesto.cpe.gov.co/Athena/_img/logos/xlogo.png";
$_SESSION['serversmtp'] = "gestionsis@mincit.gov.co";
