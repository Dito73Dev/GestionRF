...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelstparam_sn["Spanish"]["snid"] = "Snid";
	$fieldToolTipstparam_sn["Spanish"]["snid"] = "";
	$placeHolderstparam_sn["Spanish"]["snid"] = "";
...
$tdatatparam_sn[".connId"] = "dbrf_at_127_0_0_1";
...
$tdatatparam_sn[".badgeColor"] = "008B8B";
...
$tdatatparam_sn[".googleLikeFields"][] = "snid";
...
$tdatatparam_sn[".sqlHead"] = "SELECT snid,  	sn";
...
//	Custom field settings
	...
	$fdata["Label"] = GetFieldLabel("tparam_sn","snid");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdatatparam_sn["snid"] = $fdata;
		$tdatatparam_sn[".searchableFields"][] = "snid";
//	sn
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 2;
