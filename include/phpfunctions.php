...
{
	$value = "";
				if($table=="gedocumentos_ingresos" && $field=="do_file")
	{
		;
		return $value;
	}
				if($table=="gedocumentos_ingresos_consumo" && $field=="do_file")
	{
		;
		return $value;
	}
				if($table=="gedocumentos_egresos" && $field=="do_file")
	{
		;
		return $value;
	}
				if($table=="gedocumentos_egresos_consumo" && $field=="do_file")
	{
		;
		return $value;
	}
...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="alasientos" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="aldevindiv_sol" && $field=="username_id")
	{
		return $_SESSION["UserID"];
	}
				if($table=="aldevindiv_sol" && $field=="sol_rad")
	{
		return generarToken();;
	}
				if($table=="aldevindiv_sol" && $field=="sol_estado")
	{
		return 1;
	}
				if($table=="aldevindiv_sol" && $field=="sol_userfr")
	{
		return $_SESSION["GID"];
	}
				if($table=="aldevindiv_sol" && $field=="sol_userid")
	{
		return $_SESSION["GID"];
	}
				if($table=="aldevindiv_sol" && $field=="sol_fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="aldevindiv_sol" && $field=="sign_a_hash")
	{
		return generarTokenSign();;
	}
				if($table=="aldevindiv_sol" && $field=="sign_b_hash")
	{
		return generarTokenSign();;
	}
				if($table=="aldevindiv_sol_vinc" && $field=="aldevindiv_id_fk")
	{
		return $_SESSION["UDocumento"];
	}
				if($table=="aldevindiv_sol_vinc" && $field=="transactvinc_status")
	{
		return 0;
	}
				if($table=="aldevindiv_reintegros" && $field=="usr_username")
	{
		return $_SESSION["UserID"];
	}
				if($table=="aldevindiv_sol_vinc_adm" && $field=="aldevindiv_id_fk")
	{
		return $_SESSION["UDocumento"];
	}
				if($table=="aldevindiv_sol_vinc_adm" && $field=="transactvinc_status")
	{
		return 1;
	}
				if($table=="aldevindiv_sol_sign_a" && $field=="username_id")
	{
		return $_SESSION["UserID"];
	}
				if($table=="aldevindiv_sol_sign_a" && $field=="sol_estado")
	{
		return 1;
	}
				if($table=="aldevindiv_sol_sign_a" && $field=="sol_userfr")
	{
		return $_SESSION["GID"];
	}
				if($table=="aldevindiv_sol_sign_a" && $field=="sol_fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="aldevindiv_sol_sign_a" && $field=="sign_a_hash_v_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="aldevindiv_sol_sign_a" && $field=="sign_a_hash_v_ip")
	{
		return $_SESSION['user_ip'];;
	}
				if($table=="aldevindiv_sol_sign_a" && $field=="sign_b_hash_v_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="aldevindiv_sol_sign_a" && $field=="sign_b_hash_v_ip")
	{
		return $_SESSION['user_ip'];;
	}
				if($table=="aldevindiv_sol_vinc_sign" && $field=="aldevindiv_id_fk")
	{
		return $_SESSION["UDocumento"];
	}
				if($table=="aldevindiv_sol_vinc_sign" && $field=="transactvinc_status")
	{
		return 0;
	}
				if($table=="aldevindiv_sol_sign_b" && $field=="username_id")
	{
		return $_SESSION["UserID"];
	}
				if($table=="aldevindiv_sol_sign_b" && $field=="sol_estado")
	{
		return 1;
	}
				if($table=="aldevindiv_sol_sign_b" && $field=="sol_userfr")
	{
		return $_SESSION["GID"];
	}
				if($table=="aldevindiv_sol_sign_b" && $field=="sol_fecha")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="aldevindiv_sol_sign_b" && $field=="sign_a_hash_v_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="aldevindiv_sol_sign_b" && $field=="sign_a_hash_v_ip")
	{
		return $_SESSION['user_ip'];;
	}
				if($table=="aldevindiv_sol_sign_b" && $field=="sign_b_hash_v_date")
	{
		return strftime("%Y-%m-%d %H:%M:%S");
	}
				if($table=="aldevindiv_sol_sign_b" && $field=="sign_b_hash_v_ip")
	{
		return $_SESSION['user_ip'];;
	}
				if($table=="gedocumentos_ingresos" && $field=="do_tipomov")
	{
		return 1;
	}
				if($table=="gedocumentos_ingresos" && $field=="doclasedoc")
	{
		return 314;
	}
				if($table=="gedocumentos_ingresos" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="gedocumentos_ingresos" && $field=="do_dep")
	{
		return 318;
	}
				if($table=="gedocumentos_ingresos" && $field=="do_depsup")
	{
		return 204;
	}
				if($table=="alasientos_gestion" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="almovdevdia_ingresos_d" && $field=="mdd_cantmovto_verifica")
	{
		return 0;
	}
				if($table=="almovdevdia_ingresos_d" && $field=="geusuario")
	{
		return $_SESSION["UserID"];
	}
				if($table=="gedocumentos_ingresos_consumo" && $field=="do_tipomov")
	{
		return 1;
	}
				if($table=="gedocumentos_ingresos_consumo" && $field=="doclasedoc")
	{
		return 311;
	}
				...
				if($table=="almovconsdia_ingresos" && $field=="geusuario")
	{
		return $_SESSION["UserID"];
				...
				if($table=="alasientos_gestion_e" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="gedocumentos_egresos" && $field=="do_tipomov")
	{
		return 2;
	}
				if($table=="gedocumentos_egresos" && $field=="doclasedoc")
	{
		return 315;
	}
				if($table=="gedocumentos_egresos" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="gedocumentos_egresos_consumo" && $field=="do_tipomov")
	{
		return 2;
	}
				if($table=="gedocumentos_egresos_consumo" && $field=="doclasedoc")
	{
		return 310;
	}
				if($table=="gedocumentos_egresos_consumo" && $field=="sys_user")
	{
		return $_SESSION["UserID"];
	}
				if($table=="gedocumentos_egresos_consumo" && $field=="do_dep")
	{
		return 318;
	}
				if($table=="gedocumentos_egresos_consumo" && $field=="do_depsup")
	{
		return 204;
	}
	return "";
