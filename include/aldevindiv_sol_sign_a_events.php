 ...
 */
 ...
 class eventclass_aldevindiv_sol_sign_a  extends eventsBase
{
...
<p>Este es para certificar que el siguiente documento ha sido firmado electrónicamente por:<br>
   <span class='signature'>".$values['sign_a_email']."</span>
    </p>
    <p class='timestamp'>Fecha y Hora de Firma: ".$values['sign_a_hash_v_date']."</p>
    <p class='first-signature'>Esta es la primera firma electrónica de este documento.</p>
...
$subject="Módulo de inventario | Documento firmado No.".$values['sol_rad'];
...
<p>Este es para certificar que el siguiente documento ha sido firmado electrónicamente por:<br>
  ...
  <img src='[URL_DEL_LOGO]' alt='Logo de [Nombre de la empresa]'>";
$subjectb="Módulo de inventario | Primera firma Radicado No.".$values['sol_rad'];
...
function BeforeEdit(&$values, &$sqlValues, $where, &$oldvalues, &$keys, &$message, $inline, $pageObject)
{
		...
		$return = true;
if($values['sign_a_hash_v'] != $values['sign_a_hash']){
