...
require_once("include/almovinddia_ingresos_d_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "almovinddia_ingresos_d" );
