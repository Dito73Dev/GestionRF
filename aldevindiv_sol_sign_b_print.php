...
require_once("include/aldevindiv_sol_sign_b_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "aldevindiv_sol_sign_b" );
