...
require_once("include/almovdevdia_ingresos_d_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "almovdevdia_ingresos_d" );
