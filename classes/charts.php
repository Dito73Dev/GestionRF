...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("alasientos" == $this->chrt_array['tables'][0])
			return true;
		if("alconceptos" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_estadoasientos" == $this->chrt_array['tables'][0])
			return true;
		if("inv_almacen" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_tipo_movimiento" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_status" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol_vinc" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol_estados" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol_type" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol" == $this->chrt_array['tables'][0])
			return true;
		if("q_global_enservicio" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol_vinc" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol_estados_vinc" == $this->chrt_array['tables'][0])
			return true;
		if("alcuentasalma" == $this->chrt_array['tables'][0])
			return true;
		if("alelemdevolutivo" == $this->chrt_array['tables'][0])
			return true;
		if("almarcas" == $this->chrt_array['tables'][0])
			return true;
		if("cgc_0" == $this->chrt_array['tables'][0])
			return true;
		if("cgc_1" == $this->chrt_array['tables'][0])
			return true;
		if("cgc_2" == $this->chrt_array['tables'][0])
			return true;
		if("cgc_4" == $this->chrt_array['tables'][0])
			return true;
		if("cgc_6" == $this->chrt_array['tables'][0])
			return true;
		if("q_global_enservicio" == $this->chrt_array['tables'][0])
			return true;
		if("alelemconsumo" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_sn" == $this->chrt_array['tables'][0])
			return true;
		if("geunidmedida" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_alelemdevolutivo" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_alelemconsumo" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_valor_uvt" == $this->chrt_array['tables'][0])
			return true;
		if("global_periodos" == $this->chrt_array['tables'][0])
			return true;
		if("geclasedocto" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv_sol_vinc" == $this->chrt_array['tables'][0])
		...
		if("alasientos" == $this->chrt_array['tables'][0])
			return true;
		if("global_type_doc" == $this->chrt_array['tables'][0])
			return true;
		if("contractor_master" == $this->chrt_array['tables'][0])
			return true;
		if("q_ctrl_numdocumento" == $this->chrt_array['tables'][0])
			return true;
		if("dependencias_001" == $this->chrt_array['tables'][0])
			return true;
		if("dependencia" == $this->chrt_array['tables'][0])
			return true;
		if("almovdevdia" == $this->chrt_array['tables'][0])
			return true;
		if("global_type_tax" == $this->chrt_array['tables'][0])
			return true;
		if("alelemdevolutivo" == $this->chrt_array['tables'][0])
			return true;
		if("almovinddia" == $this->chrt_array['tables'][0])
			return true;
		if("cgc_6" == $this->chrt_array['tables'][0])
			return true;
		if("gedocumentos" == $this->chrt_array['tables'][0])
			return true;
		if("almovconsdia" == $this->chrt_array['tables'][0])
			return true;
		if("alelemconsumo" == $this->chrt_array['tables'][0])
			return true;
		if("gedocumentos" == $this->chrt_array['tables'][0])
		...
		if("alasientos" == $this->chrt_array['tables'][0])
			return true;
		if("global_type_legal" == $this->chrt_array['tables'][0])
			return true;
		if("gedocumentos" == $this->chrt_array['tables'][0])
			return true;
		if("gedocumentos" == $this->chrt_array['tables'][0])
			return true;
		if("aldevindiv" == $this->chrt_array['tables'][0])
			return true;
		if("almovinddia" == $this->chrt_array['tables'][0])
			return true;
		if("almovinddia" == $this->chrt_array['tables'][0])
