...
function fillProjectEntites()
{
	...
	$projectEntities[ "alasientos" ] = array( "url" => "alasientos", "type" => 0 );
	$projectEntitiesReverse[ "alasientos" ] = "alasientos";
	$projectEntities[ "alconceptos" ] = array( "url" => "alconceptos", "type" => 0 );
	$projectEntitiesReverse[ "alconceptos" ] = "alconceptos";
	$projectEntities[ "tparam_estadoasientos" ] = array( "url" => "tparam_estadoasientos", "type" => 0 );
	$projectEntitiesReverse[ "tparam_estadoasientos" ] = "tparam_estadoasientos";
	$projectEntities[ "inv_almacen" ] = array( "url" => "inv_almacen", "type" => 0 );
	$projectEntitiesReverse[ "inv_almacen" ] = "inv_almacen";
	$projectEntities[ "tparam_tipo_movimiento" ] = array( "url" => "tparam_tipo_movimiento", "type" => 0 );
	$projectEntitiesReverse[ "tparam_tipo_movimiento" ] = "tparam_tipo_movimiento";
	$projectEntities[ "tparam_status" ] = array( "url" => "tparam_status", "type" => 0 );
	$projectEntitiesReverse[ "tparam_status" ] = "tparam_status";
	$projectEntities[ "aldevindiv_sol" ] = array( "url" => "aldevindiv_sol", "type" => 0 );
	$projectEntitiesReverse[ "aldevindiv_sol" ] = "aldevindiv_sol";
	$projectEntities[ "aldevindiv_sol_vinc" ] = array( "url" => "aldevindiv_sol_vinc", "type" => 0 );
	$projectEntitiesReverse[ "aldevindiv_sol_vinc" ] = "aldevindiv_sol_vinc";
	$projectEntities[ "aldevindiv_sol_estados" ] = array( "url" => "aldevindiv_sol_estados", "type" => 0 );
	$projectEntitiesReverse[ "aldevindiv_sol_estados" ] = "aldevindiv_sol_estados";
	$projectEntities[ "aldevindiv_sol_type" ] = array( "url" => "aldevindiv_sol_type", "type" => 0 );
	$projectEntitiesReverse[ "aldevindiv_sol_type" ] = "aldevindiv_sol_type";
	$projectEntities[ "aldevindiv_traslados" ] = array( "url" => "aldevindiv_traslados", "type" => 1 );
	$projectEntitiesReverse[ "aldevindiv_traslados" ] = "aldevindiv_traslados";
	$projectEntities[ "aldevindiv_reintegros" ] = array( "url" => "aldevindiv_reintegros", "type" => 1 );
	$projectEntitiesReverse[ "aldevindiv_reintegros" ] = "aldevindiv_reintegros";
	$projectEntities[ "q_global_enservicio" ] = array( "url" => "q_global_enservicio", "type" => 0 );
	$projectEntitiesReverse[ "q_global_enservicio" ] = "q_global_enservicio";
	$projectEntities[ "aldevindiv_sol_vinc_adm" ] = array( "url" => "aldevindiv_sol_vinc_adm", "type" => 1 );
	$projectEntitiesReverse[ "aldevindiv_sol_vinc_adm" ] = "aldevindiv_sol_vinc_adm";
	$projectEntities[ "aldevindiv_sol_estados_vinc" ] = array( "url" => "aldevindiv_sol_estados_vinc", "type" => 0 );
	$projectEntitiesReverse[ "aldevindiv_sol_estados_vinc" ] = "aldevindiv_sol_estados_vinc";
	$projectEntities[ "alcuentasalma" ] = array( "url" => "alcuentasalma", "type" => 0 );
	$projectEntitiesReverse[ "alcuentasalma" ] = "alcuentasalma";
	$projectEntities[ "alelemdevolutivo" ] = array( "url" => "alelemdevolutivo", "type" => 0 );
	$projectEntitiesReverse[ "alelemdevolutivo" ] = "alelemdevolutivo";
	$projectEntities[ "almarcas" ] = array( "url" => "almarcas", "type" => 0 );
	$projectEntitiesReverse[ "almarcas" ] = "almarcas";
	$projectEntities[ "cgc_0" ] = array( "url" => "cgc_0", "type" => 0 );
	$projectEntitiesReverse[ "cgc_0" ] = "cgc_0";
	$projectEntities[ "cgc_1" ] = array( "url" => "cgc_1", "type" => 0 );
	$projectEntitiesReverse[ "cgc_1" ] = "cgc_1";
	$projectEntities[ "cgc_2" ] = array( "url" => "cgc_2", "type" => 0 );
	$projectEntitiesReverse[ "cgc_2" ] = "cgc_2";
	$projectEntities[ "cgc_4" ] = array( "url" => "cgc_4", "type" => 0 );
	$projectEntitiesReverse[ "cgc_4" ] = "cgc_4";
	$projectEntities[ "cgc_6" ] = array( "url" => "cgc_6", "type" => 0 );
	$projectEntitiesReverse[ "cgc_6" ] = "cgc_6";
	$projectEntities[ "Mi_inventario" ] = array( "url" => "mi_inventario", "type" => 1 );
	$projectEntitiesReverse[ "mi_inventario" ] = "Mi_inventario";
	$projectEntities[ "alelemconsumo" ] = array( "url" => "alelemconsumo", "type" => 0 );
	$projectEntitiesReverse[ "alelemconsumo" ] = "alelemconsumo";
	$projectEntities[ "tparam_sn" ] = array( "url" => "tparam_sn", "type" => 0 );
	$projectEntitiesReverse[ "tparam_sn" ] = "tparam_sn";
	$projectEntities[ "geunidmedida" ] = array( "url" => "geunidmedida", "type" => 0 );
	$projectEntitiesReverse[ "geunidmedida" ] = "geunidmedida";
	$projectEntities[ "q_ctrl_alelemdevolutivo" ] = array( "url" => "q_ctrl_alelemdevolutivo", "type" => 0 );
	$projectEntitiesReverse[ "q_ctrl_alelemdevolutivo" ] = "q_ctrl_alelemdevolutivo";
	$projectEntities[ "q_ctrl_alelemconsumo" ] = array( "url" => "q_ctrl_alelemconsumo", "type" => 0 );
	$projectEntitiesReverse[ "q_ctrl_alelemconsumo" ] = "q_ctrl_alelemconsumo";
	$projectEntities[ "tparam_valor_uvt" ] = array( "url" => "tparam_valor_uvt", "type" => 0 );
	$projectEntitiesReverse[ "tparam_valor_uvt" ] = "tparam_valor_uvt";
	$projectEntities[ "global_periodos" ] = array( "url" => "global_periodos", "type" => 0 );
	$projectEntitiesReverse[ "global_periodos" ] = "global_periodos";
	$projectEntities[ "geclasedocto" ] = array( "url" => "geclasedocto", "type" => 0 );
	$projectEntitiesReverse[ "geclasedocto" ] = "geclasedocto";
	$projectEntities[ "aldevindiv_sol_sign_a" ] = array( "url" => "aldevindiv_sol_sign_a", "type" => 1 );
	$projectEntitiesReverse[ "aldevindiv_sol_sign_a" ] = "aldevindiv_sol_sign_a";
	$projectEntities[ "aldevindiv_sol_vinc_sign" ] = array( "url" => "aldevindiv_sol_vinc_sign", "type" => 1 );
	$projectEntitiesReverse[ "aldevindiv_sol_vinc_sign" ] = "aldevindiv_sol_vinc_sign";
	$projectEntities[ "aldevindiv_sol_sign_b" ] = array( "url" => "aldevindiv_sol_sign_b", "type" => 1 );
	$projectEntitiesReverse[ "aldevindiv_sol_sign_b" ] = "aldevindiv_sol_sign_b";
	$projectEntities[ "gedocumentos_ingresos" ] = array( "url" => "gedocumentos_ingresos", "type" => 1 );
	$projectEntitiesReverse[ "gedocumentos_ingresos" ] = "gedocumentos_ingresos";
	$projectEntities[ "alasientos_gestion" ] = array( "url" => "alasientos_gestion", "type" => 1 );
	$projectEntitiesReverse[ "alasientos_gestion" ] = "alasientos_gestion";
	$projectEntities[ "global_type_doc" ] = array( "url" => "global_type_doc", "type" => 0 );
	$projectEntitiesReverse[ "global_type_doc" ] = "global_type_doc";
	$projectEntities[ "contractor_master_proveedores" ] = array( "url" => "contractor_master_proveedores", "type" => 1 );
	$projectEntitiesReverse[ "contractor_master_proveedores" ] = "contractor_master_proveedores";
	$projectEntities[ "q_ctrl_numdocumento" ] = array( "url" => "q_ctrl_numdocumento", "type" => 0 );
	$projectEntitiesReverse[ "q_ctrl_numdocumento" ] = "q_ctrl_numdocumento";
	...
	$projectEntities[ "almovdevdia_ingresos_d" ] = array( "url" => "almovdevdia_ingresos_d", "type" => 1 );
	$projectEntitiesReverse[ "almovdevdia_ingresos_d" ] = "almovdevdia_ingresos_d";
	$projectEntities[ "global_type_tax" ] = array( "url" => "global_type_tax", "type" => 0 );
	$projectEntitiesReverse[ "global_type_tax" ] = "global_type_tax";
	$projectEntities[ "alelemdevolutivo_consulta" ] = array( "url" => "alelemdevolutivo_consulta", "type" => 1 );
	$projectEntitiesReverse[ "alelemdevolutivo_consulta" ] = "alelemdevolutivo_consulta";
	$projectEntities[ "almovinddia_ingresos_d" ] = array( "url" => "almovinddia_ingresos_d", "type" => 1 );
	$projectEntitiesReverse[ "almovinddia_ingresos_d" ] = "almovinddia_ingresos_d";
	$projectEntities[ "cgc_consulta" ] = array( "url" => "cgc_consulta", "type" => 1 );
	$projectEntitiesReverse[ "cgc_consulta" ] = "cgc_consulta";
	$projectEntities[ "gedocumentos_ingresos_consumo" ] = array( "url" => "gedocumentos_ingresos_consumo", "type" => 1 );
	$projectEntitiesReverse[ "gedocumentos_ingresos_consumo" ] = "gedocumentos_ingresos_consumo";
	$projectEntities[ "almovconsdia_ingresos" ] = array( "url" => "almovconsdia_ingresos", "type" => 1 );
	$projectEntitiesReverse[ "almovconsdia_ingresos" ] = "almovconsdia_ingresos";
	$projectEntities[ "alelemconsumo_consulta" ] = array( "url" => "alelemconsumo_consulta", "type" => 1 );
	$projectEntitiesReverse[ "alelemconsumo_consulta" ] = "alelemconsumo_consulta";
	$projectEntities[ "gedocumentos" ] = array( "url" => "gedocumentos", "type" => 0 );
	$projectEntitiesReverse[ "gedocumentos" ] = "gedocumentos";
	$projectEntities[ "alasientos_gestion_e" ] = array( "url" => "alasientos_gestion_e", "type" => 1 );
	$projectEntitiesReverse[ "alasientos_gestion_e" ] = "alasientos_gestion_e";
	$projectEntities[ "global_type_legal" ] = array( "url" => "global_type_legal", "type" => 0 );
	$projectEntitiesReverse[ "global_type_legal" ] = "global_type_legal";
	$projectEntities[ "gedocumentos_egresos" ] = array( "url" => "gedocumentos_egresos", "type" => 1 );
	$projectEntitiesReverse[ "gedocumentos_egresos" ] = "gedocumentos_egresos";
	$projectEntities[ "gedocumentos_egresos_consumo" ] = array( "url" => "gedocumentos_egresos_consumo", "type" => 1 );
	$projectEntitiesReverse[ "gedocumentos_egresos_consumo" ] = "gedocumentos_egresos_consumo";
	$projectEntities[ "aldevindiv_egresos" ] = array( "url" => "aldevindiv_egresos", "type" => 1 );
	$projectEntitiesReverse[ "aldevindiv_egresos" ] = "aldevindiv_egresos";
	$projectEntities[ "almovinddia" ] = array( "url" => "almovinddia", "type" => 0 );
	$projectEntitiesReverse[ "almovinddia" ] = "almovinddia";
	$projectEntities[ "almovinddia_legalizados" ] = array( "url" => "almovinddia_legalizados", "type" => 1 );
	$projectEntitiesReverse[ "almovinddia_legalizados" ] = "almovinddia_legalizados";
	$projectEntities[ "almovdevdia" ] = array( "url" => "almovdevdia", "type" => 0 );
	$projectEntitiesReverse[ "almovdevdia" ] = "almovdevdia";
}
