...
class ViewUserControl extends ViewControl
{
	...
	public function init()
	{
		...
		//$this->AddJSFile("include/runnerJS/controls/".$this->viewFormat.".js", 'include/runnerJS/viewControls/ViewControl.js');
					...
					if($this->container->tName=="aldevindiv_sol" && $this->field=="sign_a_qr")
		{
			$this->settings["qr_height"] = 80; // qr height/px
$this->settings["qr_width"] = 80; // qr width/px;
		}	
					if($this->container->tName=="aldevindiv_sol" && $this->field=="sign_b_qr")
		{
			$this->settings["qr_height"] = 80; // qr height/px
$this->settings["qr_width"] = 80; // qr width/px;
		}	
					if($this->container->tName=="aldevindiv_sol_sign_a" && $this->field=="sign_a_qr")
		{
			$this->settings["qr_height"] = 128; // qr height/px
$this->settings["qr_width"] = 128; // qr width/px;
		}	
					if($this->container->tName=="aldevindiv_sol_sign_a" && $this->field=="sign_b_qr")
		{
			$this->settings["qr_height"] = 128; // qr height/px
$this->settings["qr_width"] = 128; // qr width/px;
		}	
					if($this->container->tName=="aldevindiv_sol_sign_b" && $this->field=="sign_a_qr")
		{
			$this->settings["qr_height"] = 128; // qr height/px
$this->settings["qr_width"] = 128; // qr width/px;
		}	
					if($this->container->tName=="aldevindiv_sol_sign_b" && $this->field=="sign_b_qr")
		{
			$this->settings["qr_height"] = 128; // qr height/px
$this->settings["qr_width"] = 128; // qr width/px;
		}	
