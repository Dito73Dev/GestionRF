...
require_once("include/aldevindiv_reintegros_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "aldevindiv_reintegros" );
