...
require_once("include/alelemdevolutivo_consulta_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "alelemdevolutivo_consulta" );
