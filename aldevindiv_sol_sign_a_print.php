...
require_once("include/aldevindiv_sol_sign_a_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "aldevindiv_sol_sign_a" );
